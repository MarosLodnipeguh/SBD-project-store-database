...
INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('roweroman', 1, TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('pedalujacy_piotr', 4, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-01-05', 'YYYY-MM-DD'));
INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('pedalujacy_piotr', 2, TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('szybkiRowerowiec', 5, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-01-10', 'YYYY-MM-DD'));
INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('szybkiRowerowiec', 2, TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('kraksa_mistrz', 3, TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL);
INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('wielbladNaRowerze', 4, TO_DATE('2024-01-16', 'YYYY-MM-DD'), NULL);
INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('szosaMistrz', 5, TO_DATE('2024-01-01', 'YYYY-MM-DD'), NULL);

INSERT INTO Zatrudnienie (Pracownik_login, Stanowisko_ID, od, do) VALUES ('skok_na_rower', 5, TO_DATE('2024-01-01', 'YYYY-MM-DD'), TO_DATE('2024-01-02', 'YYYY-MM-DD'));
...
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (1, 'klient1', 1, TO_DATE('2024-01-18', 'YYYY-MM-DD'), 3000.00, 'Kurier', 'Karta kredytowa', 'zrealizowane', 'kraksa_mistrz');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (2, 'klient2', 2, TO_DATE('2024-01-20', 'YYYY-MM-DD'), 200.00, 'Odbiór osobisty', 'Gotówka', 'w trakcie realizacji', 'szosaMistrz');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (3, 'klient5', 1, TO_DATE('2024-01-22', 'YYYY-MM-DD'), 150.00, 'Paczkomat', 'Przelew', 'zrealizowane', 'szosaMistrz');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (4, 'klient3', 1, TO_DATE('2024-01-23', 'YYYY-MM-DD'), 100.00, 'Kurier', 'Karta kredytowa', 'w trakcie realizacji', 'wielbladNaRowerze');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (5, 'klient4', 2, TO_DATE('2024-01-24', 'YYYY-MM-DD'), 200.00, 'Odbiór osobisty', 'Gotówka', 'zrealizowane', 'kraksa_mistrz');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (6, 'klient1', 1, TO_DATE('2024-01-25', 'YYYY-MM-DD'), 150.00, 'Paczkomat', 'Przelew', 'zrealizowane', 'wielbladNaRowerze');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (7, 'klient2', 2, TO_DATE('2024-01-26', 'YYYY-MM-DD'), 100.00, 'Kurier', 'Karta kredytowa', 'w trakcie realizacji', 'kraksa_mistrz');
INSERT INTO Zamowienie (ID, Klient_login, sklep_ID, data, suma, sposob_dostawy, sposob_platnosci, status, realizator_login) VALUES (8, 'klient5', 1, TO_DATE('2024-01-27', 'YYYY-MM-DD'), 200.00, 'Odbiór osobisty', 'Gotówka', 'zrealizowane', 'wielbladNaRowerze');
...
-- INSERT INTO Promocja (Produkt_ID, Data_rozpoczecia, Data_zakonczenia, obnizka_ceny_procentowa) VALUES (1, TO_DATE('2024-01-17', 'YYYY-MM-DD'), TO_DATE('2024-02-17', 'YYYY-MM-DD'), 10);
-- INSERT INTO Promocja (Produkt_ID, Data_rozpoczecia, Data_zakonczenia, obnizka_ceny_procentowa) VALUES (3, TO_DATE('2024-01-20', 'YYYY-MM-DD'), TO_DATE('2024-02-20', 'YYYY-MM-DD'), 15);



-- Insert data into Stan_magazynowy
INSERT INTO Stan_magazynowy (ID, data, Sklep_ID) VALUES (1, TO_DATE('2024-01-16', 'YYYY-MM-DD'), 1);
INSERT INTO Stan_magazynowy (ID, data, Sklep_ID) VALUES (2, TO_DATE('2024-01-16', 'YYYY-MM-DD'), 2);
...
INSERT INTO Wiadomosci (nadawca_login, odbiorca_login, data, tresc) VALUES ('roweroman', 'skok_na_rower', SYSDATE, 'Cześć! Chciałem się dowiedzieć, czy interesuje Cię nasza nowa oferta rowerów górskich.');
INSERT INTO Wiadomosci (nadawca_login, odbiorca_login, data, tresc) VALUES ('ADMIN', 'roweroman', SYSDATE, 'Witaj! Dziękujemy za Twoje zaangażowanie w pracę.');
